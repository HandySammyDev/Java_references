...
public class RefrigeratedItemTest {
	...
	public static void testEqualsReturnsTrue() {
		...
		Item i = new Item("Cookie", 1.50);
		RefrigeratedItem ri1 = new RefrigeratedItem(i, 3.2);
		Item ri2 = new RefrigeratedItem("Cookie", 2.00, 32.2);
		String expected = "Expected: true";
		String actual = "Actual: " + ri1.equals(ri2);
	...
	public static void testEqualsReturnsFalse() {
		...
		Item i = new Item("Cookie", 1.50);
		RefrigeratedItem ri1 = new RefrigeratedItem(i, 3.2);
		Item ri2 = new RefrigeratedItem("Chicken", 2.00, 32.2);
